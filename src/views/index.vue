  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="24">
        <blockquote class="text-warning" style="font-size: 14px">
         账户管理：一二级管理员权限管理，提供各地市相互独立的测试账户。
          <br />
          <br />
          模型验证：对上传的模型进行校验，测试后物模型、产品模型可以直接导入正式平台使用。
          <br />
          <br />
          模拟MQS消息服务器：增加消息传输过程中调试信息的展示和记录。永久保存调试记录。
          <br />
          <br />
          设备管理：支持边设备连接、添加删除子设备，增加数据上报解析。
          <br />
          <br />
          容器应用验证：模拟物联管理平台应用商店，实现APP测试。
          <br />
          <br />
          <h4 class="text-danger">
           北向接口支持：提供北向API接口模拟测试。
          </h4>
        </blockquote>
        <hr />
      </el-col>
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>smqtt平台</h2>
        <p>
          smqtt平台，围绕终端设备接入物联管理平台的技术实现，提供物模型验证、设备接入验证、APP接入验证等测试及预处理能力，实现消息交互过程的可视化，并同步调试成功结果到物联管理平台，实现终端设备在物联管理平台的“即插即用”。
        </p>
        <p>
    ...
    <el-row :gutter="20">
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 官网：<el-link
                href="http://222.188.89.202:60026"
                target="_blank"
                >http://222.188.89.202:60026/</el-link
              >
            </p>
          </div>
        </el-card>
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <span style="display: inline-block; height: 30px; line-height: 30px">暂无信息</span>
          </div>
        </el-card>
      </el-col>
    </el-row>
